...
```js
import { Web7Client } from 'https://esm.sh/@oasisomniverse/web7-api@1.0.3';
const client = new Web7Client({ baseUrl: 'https://api.web7.oasisomniverse.one' });
```
...
const client = new Web7Client({ baseUrl: '...', fetchImpl: fetch });
```
